  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <div className="container mx-auto">
        {isLoading ? (
          <Placeholder variant={"h-[16rem] lg:h-[26rem] w-full"} />
        ) : (
          <>
            {contact?.location && (
              <MyMap
      ...
      {isLoading ? (
        <div className="my-4 container md:mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          <div className="md:mx-0 col-span-1 md:col-span-2 lg:col-span-1">
            <Placeholder variant={"aspect-video w-full h-auto rounded-none md:rounded"} />
          </div>
