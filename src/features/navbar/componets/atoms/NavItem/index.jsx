...
const NavItem = ({ to, icon, text }) => {
  return (
    <>
      <NavLink
        ...
        className={({ isPending, isActive, isTransitioning }) => 
          `inline-block py-2 w-full md:w-auto box-border border-l-2 md:border-l-0 truncate ${
            ...
            isActive ? 'border-emerald-500 text-emerald-500' : 'text-slate-800'
          } ${
      ...
      >
        <div
          className={"py-[0.525rem] px-2 w-full flex items-center gap-4 hover:bg-slate-100 focus:bg-slate-100 md:rounded text-base font-semibold"}
        >
